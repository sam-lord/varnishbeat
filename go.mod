module github.com/sam-lord/varnishbeat
...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20201203171717-de28183bcb0f
	...
	golang.org/x/tools v0.0.0-20201203193412-fa6651ede5aa
